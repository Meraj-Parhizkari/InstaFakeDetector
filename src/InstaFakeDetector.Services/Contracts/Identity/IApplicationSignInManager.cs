...
public interface IApplicationSignInManager
{
    ...
    /// <returns>
    ///     The task object representing the asynchronous operation, containing the ClaimsPrincipal for the specified
    ///     user.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    ///     The task object representing the asynchronous operation containing the User/>
    ///     for the sign-in attempt.
    /// </returns>
    ...
    Task<SignInResult> SignInOrTwoFactorAsync(User user, bool isPersistent, string loginProvider = null,
    ...
    /// </summary>
    /// <returns>
    ///     The task object representing the asynchronous operation. The task will contain the current user
    ///     if the stamp matches the persisted value, otherwise it will return false.
    /// </returns>
